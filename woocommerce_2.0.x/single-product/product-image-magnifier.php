...
<div class="images">
	...
	<?php if( !yith_wcmg_is_enabled() ): ?>
		...
		<?php if ( has_post_thumbnail() ) : ?>
			...
			<a itemprop="image" href="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" class="zoom" rel="thumbnails" title="<?php echo get_the_title( get_post_thumbnail_id() ); ?>"><?php echo get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ), array( 'class' => 'shop_single' ) ) ?></a>
	...
	<?php else: ?>
		...
		<?php if ( has_post_thumbnail() ) : ?>
			...
			<a itemprop="image" href="<?php echo $thumbnail_url; ?>" class="yith_magnifier_zoom" rel="thumbnails"><?php echo get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ), array( 'class' => 'shop_single' ) ) ?></a>
