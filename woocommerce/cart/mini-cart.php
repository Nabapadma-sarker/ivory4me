            ...
            <li class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
                ...
                <?php
                    echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                        '<a href="%s" class="remove_item" title="%s" data-product_id="%s" data-product_sku="%s">%s</a>',
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
    ...
    <p class="buttons">
        <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button"><?php _e('View Cart', 'yit'); ?></a>
        <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout"><?php _e('Checkout', 'yit'); ?></a>
    </p>
