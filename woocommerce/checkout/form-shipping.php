...
<div class="woocommerce-shipping-fields">
    <?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
        ...
        <p class="form-row" id="ship-to-different-address">
            <input id="shiptobilling-checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" <?php checked($ship_to_different_address, 1); ?> type="checkbox" name="ship_to_different_address" value="1" data-woocommerce-version="<?php echo WC()->version ?>" />
