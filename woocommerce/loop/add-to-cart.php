...
$details = sprintf('<a href="%s" rel="nofollow" title="%s" class="details">%s</a>', get_permalink( $product->get_id() ), __( 'Details', 'yit' ), __( 'Details', 'yit' ));
       ...
       $add_to_cart = '';
        ...
        switch ( $product->get_type() ) {
            ...
            default :
                ...
                $quantity = apply_filters( 'add_to_cart_quantity', ( get_post_meta( $product->get_id(), 'minimum_allowed_quantity', true ) ? get_post_meta( $product->get_id(), 'minimum_allowed_quantity', true ) : 1 ) );
            break;
        }
