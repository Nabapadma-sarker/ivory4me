...
if ( ! function_exists( 'add_theme_licence' ) ) {
    /**
     * Add licence framework
     *
     * @return void
     *
    ...
    function add_theme_licence() {
        include_once( YIT_CORE_PATH . '/plugin-fw/licence/lib/yit-licence.php' );
        include_once( YIT_CORE_PATH . '/plugin-fw/licence/lib/yit-theme-licence.php' );

        YIT_Theme_Licence()->register( YIT_BOEMIA_INIT, YIT_BOEMIA_SECRETKEY, YIT_BOEMIA_SLUG );
    }
