...
yit_add_slider_config( $slider_type, array(
    ...
    array(
        ...
        'id' => 'width',
        'type' => 'number',
        'desc' => __( 'Select the width of content (take in mind 12px of padding and border of the slider, so if you want the slider 1200px width, set 1168px as width.).', 'yit' ),
        'min' => 10,
        'max' => 2000,
        'std' => 1168,
    ),
