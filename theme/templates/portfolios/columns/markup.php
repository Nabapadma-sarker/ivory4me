 				...
 				<div class="row">
 		            <ul id="portfolio" class="<?php echo $portfolio_type; ?> columns thumbnails">         
                        ...
                        <li <?php yit_work_class( $classes ) ?>>
                			...
                			<?php if(yit_work_get( 'read_more_text' ) != '') echo yit_sc_more_link( "<a class='simple-button read-more' href='{$post_permalink}'>" . yit_work_get( 'read_more_text' ) . "</a>", yit_work_get( 'read_more_text' ), $post_permalink ) ?>
                        </li>       
                        <?php $i++; endwhile ?>        
                    </ul>
