...
$socials_accepted = array( 'facebook', 'twitter', 'google', 'pinterest' , 'vkontakte' , 'linkedin' );
...
foreach ( $socials as $i => $social ) {
    if ( in_array( $social, $socials_accepted ) ) {     
        ...
        echo do_shortcode( '[social type="' . $social . '" icon_type="black-border" href="' . $url . '"' . $attrs . ' target="_blank"]' );
        echo $script;
    }
}                         
echo '</div>';