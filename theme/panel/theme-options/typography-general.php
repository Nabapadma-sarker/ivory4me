...
function yit_general_font_style( $array ) {
    $array['selectors'] = 'a, p, li, address, dd, blockquote, td, th, .paragraph-links a, a.text-color, ul.filters li a, .menu-select select, .testimonial-widget li a, .testimonial-widget li p, #search_mini, #yith-s, .newsletter-input input, .newsletter-submit input, .features-tab-container .features-tab-labels li, .features-tab-content';
    return $array;
}
...
add_filter( 'yit_links-font_std', create_function( '', 'return "#000000";' ) );
add_filter( 'yit_links-font-hover_std', create_function( '', 'return "#555";' ) );
...
add_filter( 'yit_h1-font_std', create_function( '$array', '$array["size"] = 24; $array["style"] = "bold"; return $array;' ) );
add_filter( 'yit_h2-font_std', create_function( '$array', '$array["size"] = 22; $array["style"] = "bold"; return $array;' ) );
add_filter( 'yit_h3-font_std', create_function( '$array', '$array["size"] = 15; return $array;' ) );
add_filter( 'yit_h4-font_std', create_function( '$array', '$array["size"] = 13; return $array;' ) );
add_filter( 'yit_h5-font_std', create_function( '$array', '$array["size"] = 12; return $array;' ) );
add_filter( 'yit_h6-font_std', create_function( '$array', '$array["size"] = 12; return $array;' ) );
