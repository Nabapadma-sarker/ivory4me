...
function yit_tab_typography_navigation( $fields ) {
        return array(
            ...
            20 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li ul li a, #header #nav .megamenu ul.sub-menu li a, #nav .megamenu ul.sub-menu li li a, #topbar #lang_sel ul ul li a, #nav .megamenu ul.sub-menu li.menu-item-custom-content p',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				)
            ),
            21 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li ul li a:hover, #header #nav .megamenu ul.sub-menu li > a:hover, #header #nav .megamenu ul.sub-menu li li > a:hover, #topbar #lang_sel ul ul li a:hover',
					'properties' => 'color'
				)
            ),
            22 => array(
