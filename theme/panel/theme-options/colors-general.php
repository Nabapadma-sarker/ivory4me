...
function yit_tab_colors_general( $fields ) {
    ...
    return array_merge( $fields, array(
        80 => array(
            ...
            'std' => apply_filters( 'yit_general-border-hover_std', '#959491' ),
            'style' => array(
            	'selectors' => '.portfolio-big-image .work-thumbnail .thumb-wrapper:hover,
            	                ...
            	                ul.products li.product.grid .thumbnail-wrapper:hover img',
...
function yit_general_border_style( $array ) {
    $array['selectors'] = 'code, pre, body hr,
                           #copyright .inner,
                           #footer .inner,
                           .gallery img,
